...
- **Testai:** 111 failai, 720 testai (2026-07-24 / **1.4.7**). Validacija: prebuild schema; release gate `npm run audit:release-preflight` (M1–9 EN/LT + M7 pathBranch + DS gate + typecheck + TE strict + testai), M10–12 vartai `npm run audit:m1012`, M13–15 `audit:m1315`.
