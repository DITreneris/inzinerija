...
**Implementacija:** Skaidrės 100–106 (DA_4) modulyje 7 pažymėtos kaip **optional** – dalyvis gali praleisti (Fast track) arba peržiūrėti. Pilnas vizualizacijos ir data storytelling turinys planuojamas **Moduliuose 16–18** (Duomenų inžinerijos kelias). Nuoroda: „Vizualizacija – Moduliuose 16–18“. **Įgyvendinta JSON (2026-06-30):** skaidrės 100, 101, 104, 106 išplėstos iki pilnų 4+ blokų su CopyButton; 103 papildyta „Kodėl čia?“ įžanga; 100 naudoja interaktyvią React schemą `m7_data_story_cycle`. EN overlay sinchronizuotas.
