...
> **Atnaujinta:** 2026-07-15 (archyvas: `docs/archive/` – ne SOT; M4 sk. 53.5 aktyvūs doc; docs maintenance governance)
...
| M7–M9 UX polish (operacinis SOT)                                   | `docs/development/M79_PATCH_REGISTRY.md`, `07_08_09_backlog.md` §12; priežiūra – `docs/development/DOCS_MAINTENANCE.md`                                                                                                                                                                                                                                                                                                                                                                                                                        |
