...
> **Paskirtis:** Vienas rinkodaros dokumentas – auditorija, žinutės, kanalai, funnel (LinkedIn lead magnet → WhatsApp), monetizacija (Modulis 4 mokamai), integracijos ir MUST–SHOULD–WANT.
> **Šaltiniai:** `docs/VARTOTOJU_ATSILIEPIMAI_BENDRAS.md`, ROADMAP.md, modulių struktūra. **Atnaujinta:** 2026-02-18 (WhatsApp, funnel, M4); 2026-02-25 (spin-off Nr. 2 SOT_Marketingas, LinkedIn postas numatytas 2026-02-25); 2026-03-01 (spin-off Nr. 3 Personalas – HR atrankos sistema).
...
*Principas: jei visiems siūlai tą patį – prarandi vertę.*
...
| **Spin-off: 8 promptų biblioteka** | Dalintis nuoroda [ditreneris.github.io/biblioteka](https://ditreneris.github.io/biblioteka/) **gyvų mokymų metu** ir **LinkedIn** – nemokamas trumpas įrankis (~30 min), pritraukia naujus vartotojus ir nukreipia į pilną kursą + WhatsApp. |
...
| **Kur skelbti** | LinkedIn (asmeninis profilis arba puslapis), el. paštas, WhatsApp kanalas – trumpas tekstas + nuoroda (į kursą arba į spin-off biblioteką). |
...
| **WhatsApp nurturing** | Po prisijungimo prie kanalo – trumpi pranešimai apie „kas toliau“, pasiūlymas Moduliui 4 (žr. §7). |
...
| **WhatsApp** | Bendruomenė ir nurturing po funnel; pasiūlymas Moduliui 4 mokamai. | [Prisijungti prie kanalo](https://chat.whatsapp.com/It49fzTl1n90huRCoWWkwu?mode=gi_t). |
...
**Nr. 1 – [8 promptų biblioteka](https://ditreneris.github.io/biblioteka/)** – „Leisk DI atlikti 30–50% tavo kasdienių užduočių“. 8 pratimai (~30 min), kopijuoti → ChatGPT/Claude → [ĮMONĖ], [MANO ROLĖ]. Vertė: 3–5 val/savaitę, mažiau klaidų, aiškesnis kontekstas. CTA į WhatsApp ir pilną kursą.
...
| **LinkedIn** | Nr. 1 – postai su nuoroda į biblioteką; Nr. 2 – **postas 2026-02-25** su nuoroda į [marketingas](https://ditreneris.github.io/marketingas/); Nr. 3 – postai HR auditorijai su nuoroda į [personalas](https://ditreneris.github.io/personalas/). CTA – išbandyti, prisijungti prie WhatsApp, toliau – 3 nemokami moduliai. |
...
| **3. Nurturing** | Prieiga prie Modulių 1–3; nuoroda į WhatsApp („Prisijunk prie bendruomenės“). | Užbaigę M1/M2/M3; prisijungę prie WhatsApp. |
| **4. Pasiūlymas** | WhatsApp + (optional) el. paštas: pasiūlymas įsigyti **Modulį 4** (konteksto inžinerija, RAG, haliucinacijos). | Konversijos į mokamą Modulį 4. |
...
- Alternatyva: po **WhatsApp prisijungimo** – trumpa serija (1–2 pranešimai) apie „kas toliau“, tada pasiūlymas Moduliui 4.
...
|-------|------------------------|
| **WhatsApp kanalas** | Trumpas pranešimas: kas yra Modulis 4, kodėl naudinga po 1–3, nuoroda į mokamą prieigą. |
...
- **WhatsApp:** „Sveiki! Jei jau peržiūrėjote 3 modulius – kitas žingsnis – Modulis 4: konteksto inžinerija, RAG ir kaip saugiai naudoti šaltinius. [nuoroda].“
...
| **Prisijungimai prie WhatsApp** | Grupės narių skaičius; nauji nariai po lead magnet. | Nurturing ir pasiūlymo pasiekiamumas. |
...
*Integracijų detalės – žr. §9 (M5, S7, W5).*
...
| M4 | **Nesiųsti didelės kampanijos be stabilumo** | Ramus startas – kvietimai, lead magnet, WhatsApp; reklama – tik po M1 ir social proof. |
...
- **Funnel:** LinkedIn lead magnet (3 nemokami moduliai) → prieiga / registracija → WhatsApp kanalas → nurturing → pasiūlymas Moduliui 4 mokamai.
...
2) Naudoti LinkedIn lead magnet ir siųsti nuorodas į WhatsApp kanalą.  
