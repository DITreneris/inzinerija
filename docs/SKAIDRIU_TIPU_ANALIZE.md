...
| **F) Special**                | `hallucination-dashboard`, `hallucination-pipeline`, `section-break`, `path-step`                                                                                                                                                    | Atskiras komponentas arba `slide.content`                    | M4 skaidrė 200; M7 skaidrė 67.7 (`hallucination-pipeline` – 5 žingsnių patikimumo schema); M4 skyrių skiriamosios (`section-break`); M7 Duomenų analizės kelias (`path-step` – žingsnis, badge, žodynėlio atrakinimas) |
...
| **Turinys**   | Trumpai → Daryk dabar → Copy → Patikra (be Optional)                | Klausimai, explanations                                    |
