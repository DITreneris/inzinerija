...
| Aspektas            | Aprašymas                                                                                                                                                                                                                                                                                                                                       |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Problema**        | Content-block skaidrėse 5 blokai (Trumpai → Daryk dabar → Copy → Patikra → Optional). Sticky juosta + AppNav užima ~140–160px. Mažame viewport (375px) likusi aukštis ~400px – į telpa 1–2 blokai. CTA „Kopijuoti promptą“ dažnai 3–4 bloke; „Tęsti“ – bottom nav, bet prieš jį spacer `h-20` – po paskutinio turinio bloko lieka tuščia vieta. |
...
| 4   | **Content-block: pirmas CTA (Kopijuoti) virš fold arba „Scroll to CTA“** – arba sutrumpinti pirmus blokus mobile (sutrumpintas Trumpai + Daryk dabar), arba pridėti mobile-only mygtuką „Pereiti prie veiksmo“ (smooth scroll į pirmą CTA).                                                                            | `ContentSlides.tsx` arba ModuleView                  | CTA greičiau pasiekiamas.                                       |
...
| „Pereiti prie veiksmo“ arba sutrumpintas Trumpai mobile           | CTA pasiekiamumas    | Mažesnė trintis.        |
