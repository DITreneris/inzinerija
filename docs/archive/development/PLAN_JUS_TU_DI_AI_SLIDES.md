...
### 2.9 `src/data/modules.json` – Modulis 3 praktikos scenarijai (`practicalTask.instructions.steps`)

**Kada:** 2026-06-30 (įgyvendinta).

| Vieta                                        | Dabar (LT)                                                                                                                                                 | Pakeisti į                                                                                                                               |
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Žingsnių `title` (6 scenarijų × 6 žingsniai) | `Pradėkite nuo rolės`, `Surinkite duomenis`, `Apibrėžkite formatą`, `Nustatykite mąstymo seką`, `Nustatykite kokybės kriterijus`, `Nustatykite parametrus` | `Pradėk nuo rolės`, `Surink duomenis`, `Apibrėžk formatą`, `Nustatyk mąstymo seką`, `Nustatyk kokybės kriterijus`, `Nustatyk parametrus` |
| Žingsnių `description` (likučiai)            | `Nurodykite`, `Apibrėžkite`, `Išskirkite`                                                                                                                  | `Nurodyk`, `Apibrėžk`, `Išskirk`                                                                                                         |
| Modulio `description` (M3)                   | `sukurkite savo promptus`                                                                                                                                  | `sukurk savo promptus`                                                                                                                   |
| `turinio_pletra.md` M3 situacijos            | `Jūs esate`, `jums reikia`, `Jūsų užduotis`                                                                                                                | `Tu esi`, `tau reikia`, `Tavo užduotis`                                                                                                  |

**Papildomai (turinys, ne kreipinys):** skaidrės 32–33 `template` / `partialSolution` / `hint` turi atitikti `scenario.data` (pardavimų analizė, SmartFlow kampanija).
