...
| 27     | 4.4                | Tokenų ekonomika                                                 | Kas yra tokenai, konteksto langas, max_tokens; kaip taupyti ir išlaikyti kokybę. Po RAG/Deep research – dabar aišku, _kiek_ konteksto „telpa“.                                                                                       |
...
| 52.5  | Skyrius: RAG ir Deep research            | `section-break`          | recap + `spinoffCta`       | Nukreipia iš teorijos į šaltinių ir tyrimo praktikas.                                        |
| 65.8  | Skyrius: Tokenai ir technikos            | `section-break`          | recap + `spinoffCta`       | Apibendrina 7 technikas prieš tokenų ekonomiką.                                              |
