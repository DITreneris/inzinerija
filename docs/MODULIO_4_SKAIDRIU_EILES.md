...
| 26d    | **65.8**           | **Tokenai ir technikos (section-break)**                         | Skiriamoji skaidrė – atskiria RAG/Deep research (4.3) nuo Tokenų ekonomikos (4.4). Recap 7 promptų technikų (Sisteminis, Master, Procesas, Metodinis, Agentinis, RAG promptai, Combo promptai); celebration hero, nextSteps, footer. |
| 27     | 4.4                | Tokenų ekonomika                                                 | Kas yra tokenai, konteksto langas, max*tokens; kaip taupyti ir išlaikyti kokybę. Po RAG/Deep research – dabar aišku, \_kiek* konteksto „telpa“.                                                                                      |
...
| 31     | 66.99              | Pasirink tolesnį žingsnį (interaktyvi)                           | Pasirinkimai: (1) Modulio 5 testas, (2) RAG/Deep research pakartojimas, (3) Modulio 6 projektas, (4) Modulio 4 PDF atmintinė, pasiekiama užbaigimo ekrane ir „Mano medžiaga“ bloke. M4 baigiasi šia skaidre.                         |
...
## Interaktyvumo pattern katalogas
