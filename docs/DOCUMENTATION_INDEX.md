...
| **Techninė atspirties dokumentacija** (inventorius, architektūra, komponentai, testai, CI) | `docs/development/GOLD_LEGACY_STANDARD.md`                                                                                                                                                                                              | Istorinis baseline v1.3.0 (M1–6 snapshot); dabartinis release **v1.4.7 + Unreleased** – žr. `CHANGELOG.md`, `docs/development/CODEBASE_WHAT_IS_DONE.md`                                                                                                                              |
...
| `docs/PEDAGOGINE_ANALIZE_MODULIAI_10_11_12.md` | Reference (ne SOT; ne lean) + max ROI backlog                                                                          |
