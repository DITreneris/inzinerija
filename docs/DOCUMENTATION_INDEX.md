...
> Open darbai: `TODO.md` §1.2g (`TE-M1618-*`) · §1.4 MON · §1.5 Deferred · Done: `docs/archive/development/TODO_DONE_SPRINTS_2026-07-31.md`.
...
| **Turinys Moduliai 16–18**                                                                 | `docs/turinio_pletra_moduliai_16_17_18.md` + eilė `MODULIO_16_SKAIDRIU_EILES.md`                                                                                                                                                        | Kodo inžinerija (Cursor-first): authoring F1–F8 + TE Must/Should done; open Could `TE-M1618-C*` `TODO.md` §1.2g; backlog `docs/development/16_17_18_backlog.md`; Wave D3 corporate18 Deferred                                                                                        |
...
| `docs/development/16_17_18_backlog.md`                 | M16–18 Kodo inžinerija: F1–F8 + TE Must/Should done; open Could C\*; Wave D3 corporate18 Deferred                 |
