...
> **Atnaujinta:** 2026-08-19 (live pin **v1.6.3** GitHub verified · ROADMAP **v4.38** · hygiene **39**)  
> **Hierarchija:** **`DOCUMENTATION_QUICK_REF.md`** (startas) → **`LEAN_INDEX.md`** (≤25 keliai) → **šis INDEX** (pilnas katalogas + archyvas).  
> Open darbai: learning P0/P1 nėra · T01 I5 parked · Should 2-as pass · TOOL-5 · §1.4 MON · §1.5 Deferred (D3). Done: [`TODO_DONE_SPRINTS_2026-08.md`](archive/development/TODO_DONE_SPRINTS_2026-08.md).
...
| **Turinys Moduliai 16–18**                                                                 | `docs/turinio_pletra_moduliai_16_17_18.md` + eilė `MODULIO_16_SKAIDRIU_EILES.md`                                                                                                                                                        | Kodo inžinerija (Cursor-first): authoring F1–F8 + TE Must/Should/C2 + learner plain done; Could won’t-now; backlog `docs/development/16_17_18_backlog.md`; Wave D3 corporate18 Deferred                                                                                              |
...
| **Techninė atspirties dokumentacija** (inventorius, architektūra, komponentai, testai, CI) | `docs/development/GOLD_LEGACY_STANDARD.md`                                                                                                                                                                                              | Istorinis baseline v1.3.0 (M1–6 snapshot); **ne** current pin. Release + live pin **v1.6.3**. `v1.4.9` = istorinis learning freeze. Žr. `CHANGELOG.md`, `docs/development/CODEBASE_WHAT_IS_DONE.md`                                                                                  |
...
| `docs/development/PLAN_AGENTAI_DARBAI.md`              | Stub → archive (M4-era plan; ne lean)                                                                             |
...
| `docs/development/M1_M3_PROMPT_MATURITY.md`            | M1–3 copyable fit-for-purpose + freeze (M1P)                                                                      |
| `docs/development/M4_PROMPT_MATURITY.md`               | M4 copyable fit-for-purpose (M4P)                                                                                 |
| `docs/development/M7_PROMPT_MATURITY.md`               | M7 copyable F/S/R/L + journey (M7P)                                                                               |
| `docs/development/CURRICULUM_AGENT.md`                 | Pedagogika, Bloom, santraukos                                                                                     |
| `docs/development/16_17_18_backlog.md`                 | M16–18 Kodo inžinerija: F1–F8 + TE Must/Should/C2 + plain done; Could won’t-now; Wave D3 corporate18 Deferred     |
| `docs/development/SCHEME_AGENT.md`                     | Schemų/diagramų gairės (+ §2.2c `interactive-control-lab`)                                                        |
| `docs/development/TEACHING_ELEMENTS_REGISTRY.md`       | Master mokymo elementų registry + brandą 0–4; overlay `teaching-elements-overlay.json`; `audit:teaching-elements` |
...
| `docs/development/DIAGRAMU_M16_M18_REGISTRY.md`        | Satelitas: M16–18 Kodo kelio schemų registry (TE-M1618-M4 ✅; live `image` keys)                                  |
| `docs/development/M13_M15_SCHEME_AUDIT.md`             | M13–15 schemų / interaktyvių elementų deep audit + max-ROI taisymo seka                                           |
| `docs/development/M13_M15_LANG_AUDIT_FINAL.md`         | M13–15 LT║EN kalbos FINAL SOT (Wave F/G/H applied; §7 TERM? savininkui)                                           |
| `docs/development/M13_M15_TERM_BANK.md`                | M13–15 KEEP / PIRMAS / KEISTI operacinė lentyna (po FINAL audito)                                                 |
...
| **Archyvas / EN**                                 | Mobile auditas: `docs/archive/audits/AUDITO_ATASKAITA_MODULIAI_1_6_MOBILE_UX.md`. EN terminologija: `CONTENT_MODULIU_ATPAZINIMAS.md` + `glossary-en.json`. **SUMMARY_SLIDE_SPEC** aktyvus: `docs/development/SUMMARY_SLIDE_SPEC.md` |
...
| `docs/PEDAGOGINE_ANALIZE_MODULIAI_4_5_6.md`            | Reference (ne SOT; ne lean)                                                                        |
| `docs/SKAIDRIU_TIPU_ANALIZE.md`                        | Reference (ne SOT; ne lean)                                                                        |
...
| `docs/development/M4_SK_53_5_SESSION_RETROSPECTIVE.md` | Stub → archive (sesijos pamokos; ne SOT)                                                           |
...
| `docs/PEDAGOGINE_ANALIZE_MODULIAI_10_11_12.md`    | Reference (ne SOT; ne lean) – pre-Wave; **ne** dabartinis rankas                                                       |
| `docs/development/M10_SLIDE_RANKING_AUDIT.md`     | Post–Wave1/2 M10 30 skaidrių balai + Top 8 backlog (operacinis)                                                        |
| `docs/development/M11_M12_SLIDE_RANKING_AUDIT.md` | Wave3-R M11+M12 16 skaidrių balai + Top 5 frozen (operacinis)                                                          |
...
| `docs/development/intake/M13_OWNER_WALK_INTAKE_2026-08.md` | M13 owner walk SYS-A…H done (2026-08-19)                                                                               |
| `docs/turinio_pletra_moduliai_16_17_18.md`                 | Turinio SOT M16–M18 (Kodo inžinerija; konsoliduota)                                                                    |
...
| Failas                                          | Paskirtis                                                                                                                                                                                                                                                                                                                      |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/marketing_plan.md`                        | **Rinkodaros planas (vienas dokumentas)** – auditorija, žinutės, kanalai (LinkedIn lead magnet, vieša Telegram grupė), funnel, monetizacija (Modulis 4 mokamai), integracijos (Brevo, GA4, UTM), MUST–SHOULD–WANT. Sąsaja: `VARTOTOJU_ATSILIEPIMAI_BENDRAS.md` §11. (Seni superseded draftai pašalinti 2026-07-24 lean purge.) |
| `docs/LinkedIn_audience_insights_2026-02-21.md` | **LinkedIn įrašo auditorijos analizė** – kas pamatė postą (2026-02-21), validacija su rinkodaros planu, įžvalgos, Kiss–Marry–Kill prioritizacija. (Raw `.txt` šaltinis pašalintas lean purge – lieka ši santrauka.)                                                                                                            |
...
DS/UX vienkartinės analizės – `docs/archive/development/analysis/`. (Senas `moduliai_7_8_9/` untracked katalogas pašalintas lean purge.)
...
4. **Kas kokiam agentui / seka** → `docs/development/AGENT_ORCHESTRATOR.md` (+ `AGENTS.md`).
