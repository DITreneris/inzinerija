...
| **Techninė atspirties dokumentacija** (inventorius, architektūra, komponentai, testai, CI) | `docs/development/GOLD_LEGACY_STANDARD.md`                                                                                                                                      | Production deploy v1.3.0 būsenos aprašas; atnaujina QA_AGENT (release) arba po didelių refaktorų                                         |
...
**User Journey seka ir modulio analizės:** `docs/archive/development/` (AGENT*SEQUENCE_USER_JOURNEY_MVP_MODULIO_ANALIZE, MODULIO*_*USER_JOURNEY_ANALIZE, M4_SKAIDRE*_, ANALIZE\_\* ir kt.) – žr. `docs/archive/README.md` (lokaliai).
