...
> **Atnaujinta:** 2026-08-19 (kiss + Unreleased gate-green · ROADMAP **v4.36** · hygiene **40** · training **v1.6.3** · live pin **v1.6.2**)  
...
| **Techninė atspirties dokumentacija** (inventorius, architektūra, komponentai, testai, CI) | `docs/development/GOLD_LEGACY_STANDARD.md`                                                                                                                                                                                              | Istorinis baseline v1.3.0 (M1–6 snapshot); **ne** current pin. Training cut **v1.6.3**; live pin **v1.6.2**. `v1.4.9` = istorinis learning freeze. Žr. `CHANGELOG.md`, `docs/development/CODEBASE_WHAT_IS_DONE.md`                                                                   |
