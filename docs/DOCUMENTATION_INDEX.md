...
> **Atnaujinta:** 2026-08-01 (M16–18 TE Must/Should done; Could open)  
> **Hierarchija:** **`DOCUMENTATION_QUICK_REF.md`** (startas) → **`LEAN_INDEX.md`** (≤25 keliai) → **šis INDEX** (pilnas katalogas + archyvas).  
> Open darbai: learning P1 nėra · §1.4 MON · §1.5 Deferred (D3 corporate18) · Done: `docs/archive/development/TODO_DONE_SPRINTS_2026-07-31.md`.
