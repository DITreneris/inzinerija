...
- Turinys patikrintas pagal DOCUMENTATION*INDEX, CONTENT_MODULIU_ATPAZINIMAS, ANALIZE_MODULIAI*\*\_UI_UX_USABILITY, MODULIU_7_8_9_GILI_ANALIZE_VERDIKTAS, ROADMAP, VARTOTOJU_ATSILIEPIMAI_BENDRAS.
