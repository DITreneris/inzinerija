...
| **Sekcijų schema (TL;DR → Do now → Copy → Quality → Optional)** | **FAIL** | Klasikinės content-block sekos nėra: yra TL;DR + Daryk dabar + 3 šablonų blokai, bet nėra vieno aiškaus „Copy-paste prompt“ bloko, nėra „Quality check“, nėra „Optional“. Skaidrė – 3 šablonų kortelės, ne viena veiksmo eilė. |
...
| **Sekcijų antraštės savarankiškos** | **OK** | „Trumpai (TL;DR)“, „Daryk dabar“, „1. MOKYTIS…“, „2. EKSPERIMENTUOTI…“, „3. PERŽIŪRĖTI…“ – suprantami be skaidrės pavadinimo. |
...
- **Pavadinimas „SUPER PROMPTAI“** – projekte įsitvirtinęs (SOT, modulio aprašymai). Rekomenduojama **palikti**, bet:
  ...
  - Jei norima sumažinti „hype“ – galima antraštę palikti, o TL;DR pirmame sakinyje naudoti „Trys universalūs promptų šablonai“ (be „super“), arba palikti kaip yra.
...
- **CHANGES (minimalūs):** `modules.json` skaidrė 63: section „Daryk dabar“ → `blockVariant: "brand"` vietoj „violet“; papildyti „Daryk dabar“ arba TL;DR pirmu rekomenduojamu žingsniu; optional – vienas sakinys 20/80 paaiškinimui; optional – tekstas po EKSPERIMENTUOTI apie haliucinacijas (SOT).
