...
_SOT: `turinio_pletra.md` (Skaidrė 3: Workflow Samprata), `docs/development/WORKFLOW_SAMPRATA_UX_AUDITAS.md`. Runtime: `modules.json` id 15, `workflowComparisonConfig.ts`, `WorkflowComparisonInteractiveBlock.tsx`._
