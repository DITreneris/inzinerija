...
| **Duomenų tiesa**                                                                          | `src/data/modules.json`, `src/data/modules-m1-m6.json`, `src/data/modules-m1-m9.json`, `src/data/modules-en-m10-m12.json`, `src/data/promptLibrary.json`, `src/data/glossary.json`, `src/data/glossary-m1-m6.json`, `src/data/glossary-m1-m9.json`, `src/data/tools.json`, `src/data/tools-m1-m6.json`, `src/data/tools-m1-m9.json`, `src/data/hallucinationRates.ts` |
...
**Architektūra A:** `src/data/modules.json`, `src/data/glossary.json` ir `src/data/tools.json` lieka full redagavimo SOT. Du build profiliai generuojami per `npm run generate:core-data`: `*-m1-m6.json` (`VITE_MVP_MODE=1`) ir `*-m1-m9.json` (`VITE_MAX_BUILD_MODULE=9`). EN overlay M10–12: `modules-en-m10-m12.json` (deep-merge; failas partial struktūra, body pilnas; merge kai `maxModuleId >= 10`; ne `build:corporate`). Keitimai M10+ **nereikalauja** core profilio sync.
...
| **B) Duomenys (JSON/duomenys)** – struktūra, validacija, sinchronas su turiniu, duomenų kokybė                                                                   | **DATA_AGENT**                 | full SOT: `modules.json`, `glossary.json`, `tools.json`; core profiliai: `*-m1-m6.json`, `*-m1-m9.json`; EN overlay: `modules-en-m10-m12.json`; taip pat `promptLibrary.json`, `hallucinationRates.ts` |
...
**Rolė:** Duomenų sluoksnio prižiūrėtojas. Full authoring SOT: `modules.json`, `glossary.json`, `tools.json`; core profiliai: `modules-m1-m6.json`, `modules-m1-m9.json`, `glossary-m1-m6.json`, `glossary-m1-m9.json`, `tools-m1-m6.json`, `tools-m1-m9.json`; EN overlay: `modules-en-m10-m12.json`; taip pat `promptLibrary.json`, `hallucinationRates.ts`. Tipai – `src/types/modules.ts`. UI keičia CODING_AGENT.
