...
| **Turinio tiesa (Moduliai 16–18)**                                                         | `docs/turinio_pletra_moduliai_16_17_18.md` (curriculum draft; JSON later / Deferred)                                                                                                                                                                                                                                                                                                            |
| **Turinio atpažinimas** (kur kalbama apie Modulį 1…6, skaidrės)                            | `docs/CONTENT_MODULIU_ATPAZINIMAS.md`                                                                                                                                                                                                                                                                                                                                                           |
| **Duomenų tiesa**                                                                          | `src/data/modules.json`, `src/data/modules-m1-m6.json`, `src/data/modules-m1-m9.json`, `src/data/modules-en-m10-m12.json`, `src/data/promptLibrary.json`, `src/data/glossary.json`, `src/data/glossary-m1-m6.json`, `src/data/glossary-m1-m9.json`, `src/data/tools.json`, `src/data/tools-en.json`, `src/data/tools-m1-m6.json`, `src/data/tools-m1-m9.json`, `src/data/hallucinationRates.ts` |
...
**Architektūra A:** `src/data/modules.json`, `src/data/glossary.json`, `src/data/tools.json` ir `src/data/tools-en.json` (exact `name` parity; gate `npm run audit:tools` / `validate:schema`) lieka full redagavimo SOT. Du build profiliai generuojami per `npm run generate:core-data`: `*-m1-m6.json` (`VITE_MVP_MODE=1`) ir `*-m1-m9.json` (`VITE_MAX_BUILD_MODULE=9`). EN overlay M10–12: `modules-en-m10-m12.json` (deep-merge; failas partial struktūra, body pilnas; merge kai `maxModuleId >= 10`; ne `build:corporate`). Keitimai M10+ **nereikalauja** core profilio sync.
...
| **B) Duomenys (JSON/duomenys)** – struktūra, validacija, sinchronas su turiniu, duomenų kokybė                                                                   | **DATA_AGENT**                 | full SOT: `modules.json`, `glossary.json`, `tools.json`+`tools-en.json`; core profiliai: `*-m1-m6.json`, `*-m1-m9.json`; EN overlay: `modules-en-m10-m12.json`; taip pat `promptLibrary.json`, `hallucinationRates.ts` |
