...
| **Turinio tiesa (Moduliai 10–12)**                                                         | `docs/turinio_pletra_moduliai_10_11_12.md` — **gyvas turinys FREEZE** (hygiene liekana **41**; nevaryti į 0; T01–T08 Must chrome ✅; T01 I5 parked; pin v1.6.2). Chrome = `build:modules-en-m10-m12`, ne `generate:core-data`. Intake: `M10_M12_TESTER_INTAKE_2026-08.md`.                                                                                                                                                                                              |
| **Turinio tiesa (Moduliai 13–15)**                                                         | `docs/turinio_pletra_moduliai_13_14_15.md` (authoring)                                                                                                                                                                                                                                                                                                                                                                                                                  |
