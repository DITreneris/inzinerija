...
| **Turinio tiesa (Moduliai 16–18)**                                                         | `docs/turinio_pletra_moduliai_16_17_18.md` + eilė `MODULIO_16_SKAIDRIU_EILES.md` + full SOT JSON; open TE = `TODO.md` §1.2g                                                                                                                                                                                                                                                                                                                                             |
...
- **Moduliai 16–18 (Kodo inžinerija):** Authoring + TE Must done (`TE-M1618-0`…`M5`); open Should/Could `TODO.md` §1.2g (`S*` / `C*`). Registry `DIAGRAMU_M16_M18_REGISTRY.md` + overlay prieš naujus `image`/lab keys. S1 Feature Doc `M16_DIRECTION_PICKER_LAB.md`. Corporate18 = Wave D3 Deferred. Ne painioti su M7 viz 100–106.
