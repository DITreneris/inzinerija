...
| **Moduliai 16–18**                        | `docs/turinio_pletra_moduliai_16_17_18.md` + eilė + `modules.json`                                                | Kodo inžinerija: M16 D1+D2, M17 testas, M18 D3–D5; Cursor-first; TE Must ✅; open S1 lab copy = `M16_DIRECTION_PICKER_LAB.md`                                  |
| **M16–18 copyable branda**                | `docs/development/M16_M18_PROMPT_MATURITY.md` (TE-M1618-S4 ✅)                                                    | Brief / Rules / Cursor / Klaidos / Planas klasės; handoff → DATA (`build:modules-en-m16-m18`)                                                                  |
| **Skaidrių eilė M10**                     | `docs/MODULIO_10_SKAIDRIU_EILES.md`                                                                               | **Privaloma** prieš keičiant M10 skaidrių seką                                                                                                                 |
| **Skaidrių eilė M13**                     | `docs/MODULIO_13_SKAIDRIU_EILES.md`                                                                               | **Privaloma** prieš keičiant M13 skaidrių seką (13.12 / 13.32 / 13.52 MUST; Legal runtime **13.101**; I2V **13.47** po 13.4)                                   |
| **M13 I2V builder (Feature Doc)**         | `docs/development/M13_I2V_CLIP_BUILDER.md`                                                                        | Tipas `i2v-generatorius` (special); copy Trumpai/Patikra + `i2vGen` i18n; 13.37 meter → `vaizdoGen` / patikra sync (≥ proporcijos + A/E/C)                     |
...
- **Chips `autoSelect: false`:** kai sprendimas turi būti commit (ne default pirmoji eilutė) – M10/10.35 Zapier/Make/n8n/PA. Omitted/`true` = auto-select first (10.48). Linked copyable lieka paslėptas kol nėra pasirinkimo.
