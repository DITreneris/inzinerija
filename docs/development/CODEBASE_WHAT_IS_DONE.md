...
> **Tikslas:** Viena vieta – kas dabar veikia, kokie duomenys, kokybė, apimtis. Atnaujinta: 2026-07-24 (release **1.4.6** + Unreleased pre-launch auditas / LMS polish).
...
| **Testai**                                | ✅ 103 failai, 686 testai               | Vitest + RTL; unit, component, integration, a11y smoke, gate tier 9, handout PDF (M1/M4/M5/M6/M79/M1012/M1315), tier 4/5 eligibility, diagram / LMS polish guards, M10–15 EN/data-contract audit guard'ai, journey copy / icon resolve (2026-07-24).                                                                                                                                                                                           |
...
- **103 testų failai, 686 testai** (unit + component + integration; 2026-07-24 HEAD po pre-launch gate fix + diagram polish).
