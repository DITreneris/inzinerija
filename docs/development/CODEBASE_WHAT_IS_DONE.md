...
> **Tikslas:** Viena vieta – kas dabar veikia, kokie duomenys, kokybė, apimtis. Atnaujinta: 2026-06-30 (release 1.4.0).
...
| **Testai**                                | ✅ 43 failai, 266 testai | Vitest + RTL; unit, component, integration, a11y smoke, gate tier 9, mvp.gating.                                                                                                                          |
| **Validacija**                            | ✅                       | `validate-schema.mjs` – full, core (`*-m1-m6`, `*-m1-m9`), EN overlays, glossary, tools. `sot_index.json` – `validate-sot-index.mjs`.                                                                     |
| **Access tier**                           | ✅                       | Magic link tier 3 \| 6 \| 9; `getMaxAccessibleModuleId()`, užrakinimas modulių.                                                                                                                           |
| **MVP režimas**                           | ✅                       | `VITE_MVP_MODE=1` – M1–M6; production `npm run build:production` – M1–M9.                                                                                                                                 |
...
- **43 testų failai, 266 testai** (unit + component + integration).
