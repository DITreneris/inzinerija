...
> **Tikslas:** Viena vieta – kas dabar veikia, kokie duomenys, kokybė, apimtis. Atnaujinta: 2026-07-16 (release **1.4.5** + Unreleased A–C residual / Lygis C).
...
| **Testai**                                | ✅ 74 failai, 512 testai                | Vitest + RTL; unit, component, integration, a11y smoke, gate tier 9, handout PDF (M1/M4/M5/M6/M79/M1012/M1315), tier 4/5 eligibility, diagram registry guards, M10–15 EN/data-contract audit guard'ai, journey copy / icon resolve (2026-07-16).                                                                                                 |
...
- **74 testų failai, 512 testai** (unit + component + integration; 2026-07-16 HEAD po M7 Lygis C + A–C residual).
