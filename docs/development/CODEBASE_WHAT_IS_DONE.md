...
> **Tikslas:** Viena vieta – kas dabar veikia, kokie duomenys, kokybė, apimtis. Atnaujinta: 2026-07-26 (Unreleased: žodynas open+search + M7–9 term packs; release bazė **1.4.7**).
...
| **Testai**                                       | ✅ 117 failai, 745 testai               | Vitest + RTL; unit, component, integration, a11y smoke, gate tier 9, handout PDF (M1/M4/M5/M6/M79/M1012/M1315), tier 4/5 eligibility, diagram / LMS polish guards, M10–15 EN/data-contract audit guard'ai, journey copy / icon resolve; + M7 path map / prompt-tool / preCopy / ltPlural (2026-07-25).                                                                                                                                         |
...
- **117 testų failai, 745 testai** (unit + component + integration; 2026-07-25 Unreleased po M4/M7 UX + 1.4.7 baseline).
...
- **M7–9 / M10–12 learning QA:** open `TODO.md` §1.1–§1.2 (browser smoke, §4.6 residual, PDF, M10–12 chrome).
