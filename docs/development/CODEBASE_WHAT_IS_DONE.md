...
> **Tikslas:** Viena vieta – kas dabar veikia, kokie duomenys, kokybė, apimtis. Atnaujinta: 2026-07-27 (release **1.4.9**: learning QA closeout, PC-4, preflight **130/825**).
...
| **Testai**                                       | ✅ 130 failai, 825 testai               | Vitest + RTL; unit, component, integration, a11y smoke, gate tier 9, handout PDF (M1/M4/M5/M6/M79/M1012/M1315), tier 4/5 eligibility, diagram / LMS polish guards, M10–15 EN/data-contract audit guard'ai, journey / M9 quest / manipulation-contrast; + PC-4 / M5 handout score-0. `@ tag 1.4.9` = **130/825** (`@ tag 1.4.8` freeze = 126/781).                                                                                              |
...
- **130 testų failai, 825 testai** (unit + component + integration; `@ tag 1.4.9` = 130/825; `@ tag 1.4.8` freeze = 126/781).
