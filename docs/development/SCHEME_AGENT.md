...
| **DI sistemos veikimo režimai (4.1c, LlmArch W6)**                                                | `LlmArchDiagramBlock.tsx` + `LlmArchDiagramDiagram.tsx` – Pattern `comparison-mode-architecture` (Shell=Ne): Bazinis/RAG/Agentinis; `llmArchLayout.ts` + `llmArchReturnPath.ts`. Mode-absent = dashed + „Neaktyvu“. Mobile stack + reflow (`&lt;lg` vertical spine; compact return pad). Enlargeable = mobile frame only (enlarge OFF). Premium key `llm_arch`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| **Modulis 7 – analizės tipai, paruošimas, 3 agentai, MASTER, haliucinacijų grandinė**             | `m7DiagramContent.ts`; `M7AnalysisTypesDiagram/Block`, `M7DataPrepWorkflowDiagram/Block`, `M7ThreeAgentsBlock`; bendras 8 žingsnių vaizdas – `M9DataWorkflowBlock` (`context="m7_master"`) + `M9DataWorkflowDiagram` (`diagramContext="m7_master"`, desktop **HTML 2×4** cards). **67.7** `hallucination-pipeline` – `HallucinationPipelineBlock` / `HallucinationPipelineDiagram` + `hallucinationPipelineContent.ts` + `useAutoplaySteps` (HTML icon-chain + autoplay etalon, Shell=Taip). `modules.json` image raktai: `m7_analysis_types`, `m7_data_prep_workflow`, `m7_three_agents_flow`, `m7_master_workflow`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Modulis 9 – 8 žingsnių duomenų ciklas**                                                         | `M9DataWorkflowDiagram.tsx` (desktop 2×4 + `↓` 4→5; mobile stack), `M9DataWorkflowBlock.tsx`, `m9DataWorkflowContent.ts` (trumpi box labeliai; pilni vardai explanation). Skaidrė id 93 – `m9_data_workflow`. HTML cards – ne SVG spine / ne `verticalFlowGeometry`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Modulis 10 – trigger, 3A, žmogaus kontrolė, depth/roles, medis, spec/incident, orkestratorius** | Shell: `AgentWorkflowBlock` (10.2, LMS etalonas density=hero + agentWorkflowLayout.ts), `M10ThreeAStrategyBlock` (10.25, horizontal 100% stacked 80/15/5 + `m10ThreeAStrategyLayout.ts`), `M10TriggerFlowBlock` (10.15, Shell 3 T/C/A; Webhook = Trigger tipas, ne 4-asis step), `M10LearningLoopBlock` (10.49, 4 makro; dual-panel + `learningLoopUpdateBus`; staged edges), `M10OrchestratorBlock` (10.482, Pattern `multi-agent-flow` Type Etalon W7 + `orchestratorRetryPath.ts`), `M10WorkflowSpecBlock` (10.65) / `M10IncidentPlaybookBlock` (10.655), `M10ToolDecisionTreeBlock` (10.35, HitArea+StepNav). **Lab (no Shell):** `M10TeamReadinessLabBlock` (10.255, `m10_team_readiness_lab`, Pattern `interactive-control-lab`) – 3 dimensijų komandos DI praktikos nuotrauka be balo; `M10HumanControlSimulatorBlock` (10.26, `m10_human_control_simulator`, Pattern `interactive-control-lab`) – risk strip; `M10DepthRolesLabBlock` (10.45, `m10_agent_taxonomy`, Pattern `interactive-control-lab`, static mini SVG – W5 dual-taxonomy Shell superseded). M12 `m12_multi_agent_schema` – W7 **layout** brother (own topology; Diagram←`m12MultiAgentSchemaLayout`). Content: `m10DiagramContent.ts` + `m10*Layout.ts`. `M10SpecIncidentBlock` – legacy. |
| **Modulis 12 – verslo multi-agent ir trys praktikos**                                             | `M12MultiAgentSchemaDiagram.tsx`, `M12MultiAgentSchemaBlock.tsx`, `m12MultiAgentSchemaContent.ts`, `m12MultiAgentSchemaLayout.ts` (skaidrė 120.5 – `m12_multi_agent_schema`, W7 layout brother) ir `M12ThreeLabsDiagram.tsx`, `M12ThreeLabsBlock.tsx`, `m12ThreeLabsContent.ts` (skaidrė 120.25 – `m12_three_labs`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Modulis 13 – Turinio kelias (procesai + iliustracijos)**                                        | Shell: `M13AecFunnelBlock` (13.1, `m13_aec_funnel`), `M13PromptStackBlock` (13.2, `m13_prompt_stack`), `M13MediaPipelineBlock` (13.12, `m13_media_pipeline`), `M13ConsistencyLockBlock` (13.32, `m13_consistency_lock`), **Lab (Shell=Ne):** `M13ConsistencyLockLabBlock` (13.325, `m13_consistency_lab`, Pattern `interactive-control-lab`; Drift + Ref checklist; Feature Doc `M13_CONSISTENCY_LOCK_LAB.md`), `M13PostprodBlock` (13.52, `m13_postprod_steps`), `M13StillWorkflowBlock` (13.35, `m13_still_workflow`, desk-stations), `TurinioWorkflowBlock` (13.11, `turinio_workflow`). Static: `M13RuleOfThirdsBlock` (13.33). **Special (Shell=Ne, ne image key):** 13.37 `vaizdo-generatorius`, 13.47 `i2v-generatorius` (`I2vGeneratoriusSlide`; Feature Doc `M13_I2V_CLIP_BUILDER.md`). Content SOT: `m13DiagramContent.ts`, `m13MediaPipelineContent.ts`, `m13ConsistencyLockContent.ts`, `m13ConsistencyLabContent.ts`, `m13PostprodContent.ts`, `m13StillWorkflowContent.ts`, `m13BusinessWorkflowContent.ts`. Routing: `diagramRenderers.tsx`. M14 – schemų nėra.                                                                                                                                                                                     |
...
| **Testai M8 / M11 / M14 / M17 – apimtis ir remediacija**                                          | `TestKnowledgeScopeDiagram.tsx`, `TestRemediationChips.tsx` – įterpta per `TestPracticeSlides.tsx` (test-intro / test-results). Bubbles/chips **turi** atspindėti graded `relatedSlideId` aibę + Path Test temos (M14: pipeline/audio-first/licencijos/C2PA; M17: brief / planavimo kokybė). Shell: Ne (ne registry `image` key).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Modulis 16–18 – Kodo inžinerija (TE Must + Should ✅)**                                         | Must + Should done: [`DIAGRAMU_M16_M18_REGISTRY.md`](DIAGRAMU_M16_M18_REGISTRY.md) + keys `m16_delivery_gates` / `m16_vsr_maturity` / `m16_user_cycle` / `m18_packet_stack` / `m18_diff_ritual` + overlay (incl. table/embed). Should S1 `lab:m16_direction_picker` (`M16_DIRECTION_PICKER_LAB.md`) · S2 `m18_launch_gates` ✅. Could C1/C3–C5 won’t-now; C2 done. Open TE = nėra. S4-INDIV — **ne** thin VerticalFlow facades.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- M16–18: `DIAGRAMU_M16_M18_REGISTRY.md` + TE Must/Should/C2 done (`TODO.md` §1.2g closed)
...
Kai registry **Pattern** = `interactive-control-lab` ir **Shell** = Ne (pvz. M10 `m10_team_readiness_lab` / skaidrė 10.255; M10 `m10_human_control_simulator` / skaidrė 10.26; M4 `m4_prompt_mode_simulator` / skaidrė 54; M10 `m10_agent_taxonomy` / skaidrė 10.45):
...
3. **UI** – `ChoiceControl` (+ optional `optionTone`) + `CopyButton`. Risk/axis strip + trade meters – kai job = pasekmė/rizika (10.26, M4/54). **10.255 team readiness:** brand-only Choice, be balo, silpniausia dimensija → kitas veiksmas. **10.45 depth-roles:** brand-only Choice (be scenarijaus, be risk strip); **static mini SVG** iliustracija lab surface viduje OK – be Shell / be `DiagramStepNav` / be 8-step spine.
...
2. **Formos individualumas (bendra taisyklė, ne tik M13)** – kiekviena schema privalo turėti savą **vizualinę metaforą**, ne tik skirtingus labelius; DoD = mokinys atskiria dvi schemas **be step text**. M13 sibling'ai: 13.12 linear / 13.32 lock-artifact / 13.52 timeline / 13.11 cycle (`M13_M15_SCHEME_AUDIT` S4-INDIV). M7 dvyniai: 73 vs 89 – identiškos `*_GEOMETRY` konstantos, skiriasi tik `stepCount` (`M7_M9_SCHEME_AUDIT` §5.5 / A5-INDIV). Pixel-parity `VerticalFlowDiagram` dedupe **nėra** DoD nė vienu atveju.
3. **Labels LT/EN** – atskiras `m13*Content.ts` / `m15*Content.ts` (`get*Labels(locale)`); CONTENT_AGENT patvirtina.
4. **Procesinė schema** – `InteractiveDiagramShell` + `DiagramStepHitArea` + `useStepDiagram`; geometrija – `verticalFlowGeometry` arba `*Layout.ts` (layout brother kai metafora ≠ pure vertical stack).
5. **Routing** – tik `diagramRenderers.tsx` (ne ContentSlides special-case).
6. **JSON** – `modules.json` + `modules-en-m13-m15.json` (`image` + caption); **ne** core `*-m1-m6` / `*-m1-m9`.
7. **Registry** – master overlay + `DIAGRAMU_M13_M15_REGISTRY.md` prieš JSON (įskaitant Visual metaphor pastabą).
8. **Content tones (GOLDEN §6b)** – SoftRose bg + per-step `DiagramTone` maps (žr. `DIAGRAMU_M13_M15_REGISTRY` „Content tones“); token SOT `contentTrackTokens.ts`. Neplėsti `DiagramTone` union rose/coral. Shell nav / CTA neliečiama.
...
- **LMS process tipas:** `DIAGRAM_TOKENS.arrow.processTipLen` (≥10) + `getProcessArrowMarkerGeom()` (`processArrowMarker.ts`), **`refX=0`** (tipas už line end). Line-end inset = shared `diagramPathGeom.shortenToTip` (ne local copies in orch/M12/loop). `arrow.markerLen` (=6) = **legacy inset**, ne process etalon – nekeisti globaliai; niekada assertinti `processTipLen === markerLen`. Orphan dim: `opacity.orphanMap` (0.55 orch/M12) vs `opacity.orphanLearningLoop` (0.5 – documented exception). Amber soft-ink text: `DIAGRAM_AMBER_INK_SOFT`.
...
- **Hierarchija ≠ process arrow:** kai juosta **priklauso** žingsniui (konfigūracija / tipai), naudoti `getHierarchyDropStroke` + `getHierarchyShelfStroke` – kotas + T-lentyna, **be** antgalio; antraštė **kairėje** nuo koto (ne ant ašies). Horizontalios rodyklės su antgaliu = kas vyksta **toliau**. Etalonas: `m10_trigger_flow` (10.15). Konfigūracijos juosta nėra 4-as Shell žingsnis.
...
**Chrome implementacijos etalonas (LMS 1A):** `InteractiveDiagramShell` (`density="hero"`) + `EnlargeableDiagram` (**mobile frame**; `showEnlargeControl` default **false**) – žr. `M7DaPipelineBlock` / `DIAGRAM_KIT_STANDARD.md` / §3.11. Po 2026-07 M5 migrate: `DiPrezentacijosWorkflowBlock` naudoja DiagramKit Shell (ne rankinį badge/nav). Process diagrams su practice lab (`ProcessStepper` / `custom_gpt_process`) – Shell = Ne; own stepper + Enlargeable (enlarge OFF).
...
| **„Peržiūrėti visą dydį“ / Išskleisti schemą** | **Default OFF** (`EnlargeableDiagram` `showEnlargeControl=false`). Wrapper lieka mobile scroll/reflow. Opt-in enlarge tik retoms tankioms statinėms iliustracijoms. **Interaktyvios schemos** (Shell, toggle, įvestys – pvz. WorkflowComparison, M7–15 process) **nereikalauja** Enlarge. Žr. GOLDEN §3.2, AGENT_VERIFICATION_NE_MELUOTI. |
