...
| **Modulis 16–18 – Kodo inžinerija (TE Must ✅)**                                                  | Must done: [`DIAGRAMU_M16_M18_REGISTRY.md`](DIAGRAMU_M16_M18_REGISTRY.md) + keys `m16_delivery_gates` / `m16_vsr_maturity` / `m16_user_cycle` / `m18_packet_stack` / `m18_diff_ritual` + overlay (incl. table/embed). Open Should: S1 `lab:m16_direction_picker` (`M16_DIRECTION_PICKER_LAB.md`) · S2 `m18_launch_gates`. S4-INDIV — **ne** thin VerticalFlow facades.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- M16–18: `DIAGRAMU_M16_M18_REGISTRY.md` + open Should/Could `TODO.md` §1.2g
