...
| **Agentų orkestratorius (M12) – legacy**                        | `AgentOrchestratorDiagram.tsx`, `AgentOrchestratorBlock.tsx` – **ne wired** learner skaidrėms. M12 **120.5** – text-only verslo multi-agent schema (be React diagramos; pašalinta 2026-06-29).                                                                                                                                                                                                                                                     |
...
| **Modulis 10 – trigger, 3A, taksonomija, medis, spec/incident** | `M10TriggerFlowBlock`, `M10ThreeAStrategyBlock`, `M10AgentTaxonomyBlock`, `M10ToolDecisionTreeBlock`, `M10SpecIncidentBlock`, `m10DiagramContent.ts`.                                                                                                                                                                                                                                                                                              |
