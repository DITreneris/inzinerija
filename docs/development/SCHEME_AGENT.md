...
| **Modulis 10 – trigger, 3A, taksonomija, medis, spec/incident** | `M10TriggerFlowBlock`, `M10ThreeAStrategyBlock`, `M10AgentTaxonomyBlock`, `M10LearningLoopBlock`, `M10ToolDecisionTreeBlock`, `M10WorkflowSpecBlock`, `M10IncidentPlaybookBlock`, `m10DiagramContent.ts`. `M10SpecIncidentBlock` lieka legacy, nebe wired learner skaidrei po 10.65 split.                                                                                                                                                                                                                                                                                                                          |
