...
| **Base path**      | Env `VITE_BASE_PATH` – kelias, po kurio servinamas app (pvz. `/anatomy/` arba `/anatomija/`). **Vite production default:** `/inzinerija/` (GitHub Pages); monorepo build – nustatyti marketingo pasirinktą kelią. |
