...
- **Marketing cutover (ne šio repo P0):** pin **v1.6.2** + Vercel `build:corporate12` + Supabase `highest_plan=12` → `access_tier=12` (Phase 1 be Stripe). Stripe Agentų €199 = Phase 2. Default pin gali likti M1–9 iki cutover.
