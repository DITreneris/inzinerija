/**
 * @deprecated Archyvuota (2026-06): nebewired ContentSlides; skaidrė 56 naudoja llm_arch_diagram. Nešalinti be QA.
  ...
  return (
    ...
    >
      <title id={`schema3-title-${uid}`}>
        DI sistema su įrankiais ir atmintimi. Įvestis → DI → Išvestis; įrankių
        naudojimas, informacijos gavimas → duomenų bazė / saugykla
      </title>
      <defs>
      ...
      <g transform={`translate(${PAD}, ${PAD})`}>
        ...
        <line
          x1={INPUT_X + BOX_W}
          y1={ROW_CY}
          x2={MODEL_X - ARROW_MARKER_LEN}
          y2={ROW_CY}
          stroke={BRAND}
          strokeWidth="1.5"
          markerEnd={`url(#s3-arrow-${uid})`}
        />
        ...
        <line
          ...
          y1={BRANCH_Y_START}
          x2={MODEL_CX}
          y2={GEN_RETR_BOX_Y - ARROW_MARKER_LEN}
          stroke={BRAND}
          strokeWidth="1.5"
          markerEnd={`url(#s3-arrow-${uid})`}
        />
        ...
        />
        <text
          x={GEN_BOX_X + GEN_BOX_W / 2}
          y={GEN_RETR_BOX_Y + GEN_BOX_H / 2 + 5}
          textAnchor="middle"
          fontFamily={FONT}
          fontSize="10"
          fontWeight="600"
        ...
        <text
          x={RETR_CX}
          y={GEN_RETR_BOX_Y + RETR_BOX_H / 2 + 5}
          textAnchor="middle"
          fontFamily={FONT}
          fontSize="10"
          fontWeight="600"
        ...
        <line
          x1={RETR_CX}
          y1={GEN_RETR_BOX_Y + RETR_BOX_H}
          x2={DB_CX}
          y2={DB_BOX_Y - ARROW_MARKER_LEN}
          stroke={BRAND}
          strokeWidth="1.5"
          markerEnd={`url(#s3-arrow-${uid})`}
        />
