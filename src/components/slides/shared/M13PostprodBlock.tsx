...
import M13PostprodDiagram from './M13PostprodDiagram';
import {
  getM13PostprodChrome,
  getM13PostprodExplanations,
} from './m13PostprodContent';

export default function M13PostprodBlock() {
  const { locale } = useLocale();
  const loc = locale === 'en' ? 'en' : 'lt';
  const explanations = getM13PostprodExplanations(loc);
  const labels = getM13PostprodChrome(loc);
