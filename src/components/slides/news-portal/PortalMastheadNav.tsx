...
import { getPortalKickerClasses, PORTAL_HEADING, PORTAL_TEXT } from './portalSurfaces';
...
export default function PortalMastheadNav({
  ...
  const utilityLabel = isEn ? 'Search · Newsletter' : 'Paieška · Naujienlaiškis';
    ...
    <header className="border-b border-gray-200/80 dark:border-gray-700/80 pb-2 mb-0.5">
      ...
      <div className="flex items-center justify-between gap-3 py-1.5">
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className={`${PORTAL_HEADING.mastheadBrand} text-base lg:text-lg`}>{portalBrand}</span>
        ...
        <div className={`flex items-center gap-2 shrink-0 ${PORTAL_TEXT.mutedXs}`}>
