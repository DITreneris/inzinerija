...
export default function PortalHeroKpiBlock({
  toolsAndYouth,
}: PortalHeroKpiBlockProps) {
    ...
    >
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
        <div className="lg:pr-4 lg:border-r lg:border-gray-100 dark:lg:border-gray-700/60">
          <div
            className={`${getPortalMetricClasses('inline')} leading-none ${NUM_COLORS.violet}`}
          >
