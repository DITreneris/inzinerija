...
export const HALLUCINATION_RATES: HallucinationRateEntry[] = [
  ...
  { id: 'gpt-5-4-nano', model: 'GPT-5.4 Nano', ratePercent: 3.1, highlight: true },
  { id: 'gemini-2-5-flash-lite', model: 'Gemini 2.5 Flash-Lite', ratePercent: 3.3 },
  { id: 'phi-4', model: 'Phi-4', ratePercent: 3.7, lowAnswerRate: true },
  { id: 'llama-3-3-70b', model: 'Llama 3.3 70B Instruct', ratePercent: 4.1 },
  { id: 'snowflake-arctic', model: 'Snowflake Arctic Instruct', ratePercent: 4.3, lowAnswerRate: true },
