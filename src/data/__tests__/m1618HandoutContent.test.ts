...
import ltContent from '../m1618HandoutContent.json';
import enContent from '../m1618HandoutContent-en.json';
import type { M1618HandoutContent } from '../handoutContentLoader';

const lt = ltContent as M1618HandoutContent;
const en = enContent as M1618HandoutContent;
...
function visibleStrings(content: M1618HandoutContent): string[] {
  return [
    content.title,
    content.subtitle,
    ...content.briefSteps,
...
describe('M16–M18 handout content parity', () => {
