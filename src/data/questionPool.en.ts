...
export const QUESTION_POOL_EN: TestQuestion[] = [
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      "The Meta block only defines the AI's role – audience and experience are in other blocks.",
    isTrue: false,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Role, experience, target audience',
      'Only numbers and data',
      'Only the result format',
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      'If the Meta block specifies the role "senior analyst", the AI response will be more expert-level than if you just say "assistant".',
    isTrue: true,
    explanation:
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      'The Input block can be left empty if AI has enough general knowledge about the topic.',
    isTrue: false,
    explanation:
  ...
  // ═══════════════════════════════════════════
  {
    ...
    type: 'mcq',
    question:
      'You want a 5-point list in English. Which block should you specify?',
  ...
  },
  {
    ...
    options: [
      'To specify the result format and structure',
      'To set the AI role',
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      'In the Output block, specifying only the language is enough – AI will decide the format itself.',
    isTrue: false,
    explanation:
  ...
  // ═══════════════════════════════════════════
  {
    ...
    options: [
      'To specify how AI should think before answering',
      'Only to add style',
      'Only to change language',
      'Only to shorten text',
    ],
    correct: 0,
    explanation:
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      'The Reasoning block is only needed for complex questions – for simple ones Meta + Input + Output is enough.',
    isTrue: true,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1) Analyze data 2) Compare periods 3) Find trends 4) Recommend actions',
      'Think well',
      'Write thoroughly',
      'Use logic',
    ],
  ...
  },
  {
    ...
    type: 'mcq',
    question:
      "Which technique best represents the Reasoning block's principle?",
  ...
  // ═══════════════════════════════════════════
  {
    ...
    options: [
      'To set quality criteria before providing the answer',
      'Only to add style',
      'Only to change language',
      'Only to shorten text',
    ],
  ...
  },
  {
    ...
    type: 'true-false',
    question:
      'The Quality Control block is optional and can be omitted from any prompt.',
    isTrue: true,
    explanation:
  ...
  },
  {
    ...
    type: 'mcq',
    question:
      'Which two parameters are most commonly used in the Advanced block?',
    options: [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    options: [
      'Workflow has a clear format and result',
      'Basic always has a dataset',
      'Workflow is only for creativity',
      'Basic always uses a template',
    ],
    correct: 0,
  ...
  // ═══════════════════════════════════════════
  {
    ...
    type: 'scenario',
    scenarioContext:
      "You're a marketing lead. You're writing a prompt to AI to generate a quarterly sales report for the board. You have: 250k EUR revenue, 1200 orders, +15% growth. The prompt starts: 'You are a senior business analyst...' and ends: 'Present the result in a table with 5 columns.'",
    question: 'Which block is missing from this prompt?',
    options: [
      'Reasoning – how to analyze the data is not specified',
  ...
  },
  {
    ...
    type: 'scenario',
    scenarioContext:
      "A colleague wrote the prompt: 'Write me an article about AI.' The result – 3 pages of generic text, no structure, no sources, in English (though they wanted another language).",
  ...
  },
  {
    ...
    type: 'scenario',
    scenarioContext:
      'You need a people report on employee satisfaction. You have survey data: 156 employees, overall satisfaction 7.2/10, weakest areas: communication (5.8) and career opportunities (6.1). You want the report in English with recommendations.',
    question:
      'Which block would specify that AI first analyses the data, then identifies problem areas, and finally provides recommendations?',
