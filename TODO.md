...
**Legenda:** P0 = produkto / monetizacija (top), P1 = aukštas (release/kokybė), P2 = vidutinis, P3 = žemas. **Atnaujinta:** 2026-07-24.

**Dabartinis fokusas:** **MON P0 + rankinė RELEASE_QA**. Pre-launch automated (2026-07-24): preflight ✅, **103/686**, docs/registry sync ✅ — lieka browser MON-1/3/5/8 + PDF QA + MON-4. UX planas: `docs/development/SLIDE_UX_INTERACTIVITY_PLAN_M1_M15.md`. **Docs sync:** `DOCS_MAINTENANCE.md` + `DOCS_SYNC_CHECKLIST.md`.
...
**DS backlog (v0.3, ne ši banga):** ContentSlides.tsx arbitrary class; .card/.btn-\* pašalinimas. (LlmArch B3 / W6 etalon – ✅ 2026-07.)
...
| **MON-2**     | Submodule pin: dokumentuoti reikalaujamą inzinerija commit (**v1.4.6** target; runbook dar `MARKETING_SUBMODULE_PIN_1.4.4.md`); gate fix, be MVP tier fallback; marketing deploy     | ⏳     | DevOps             | Marketing                  | Runbook egzistuoja; pin atnaujinti į 1.4.6 HEAD → **git push + Vercel** ⏳                          |
...
| ~~M13-4~~       | ~~M13–15 2026 best-practice curriculum refresh~~                                                                   | Authoring          | ✅ 2026-07-22 – pipeline 13.12, consistency 13.32, post-prod 13.52, audio-first, C2PA, M14×12, M15 154                                                                                       |
| ~~M13-DIA-01~~  | ~~M13–15 schemų DiagramKit upgrade (I0–I4)~~                                                                       | P3 / schema UX     | ✅ 2026-07-22 – `m13_media_pipeline`, turinio_workflow registry+shell, M15 interactive, static polish; registry `DIAGRAMU_M13_M15_REGISTRY.md`                                               |
| ~~M13-DIA-02~~  | ~~M13–15 schemas P0–P2 (W1–W5)~~                                                                                   | P3 / schema UX     | ✅ 2026-07-22 – AEC/prompt shell, M15 focus, consistency+postprod schemas, business content extract, layout SOT                                                                              |
...
| DEF-1b          | Moduliai 10–15 turinys / authoring (Arch-B, Orch schema, Reflection prompts)                                       | P3 / §3 backlog    | **Deferred – ne prioritetas** (M10+ vizualinis backlog atskirai); **išimtis 2026-07-23:** 10.26 žmogaus kontrolės simuliatorius ✅                                                           |
| ~~M10-HITL-01~~ | ~~M10 10.26 žmogaus kontrolės simuliatorius (4 režimai → 10.64 / m11-q8 / 122)~~                                   | P2 / curriculum    | ✅ 2026-07-23 – `m10_human_control_simulator`; LT/EN; registry `interactive-control-lab`; W1.1 risk strip + lab CopyButton; **docs sync** (SCHEME §2.2c, GOLDEN §3.1c, Feature Doc Contract) |
...
| M10-DIA-05      | **LMS diagram polish I0–I6** – 10.2 Agentų ciklas etalonas (`density=hero`, layout, rodyklės) → tipų roll-out      | P2 / schema UX     | ✅ 2026-07-23 – pilot + cycle/linear/roles density roll-out; brief `LMS_DIAGRAM_POLISH_10_2.md`                                                                                              |
| M10-DIA-06      | **LMS W1 cycle brothers** – DataStory, LearningLoop, RlProcess, M12 micro (`lmsCycle` tokens; ne BOX clone)        | P2 / schema UX     | ✅ 2026-07-23 – `lmsCycle` + registry/brief; Wave 2+ later                                                                                                                                   |
| M10-DIA-07      | **DS DiagramKit promote A→B→C** – canonical LMS floors, layout math, hero shells, linear+funnel etalons            | P2 / schema UX     | ✅ 2026-07-23 – supersedes Wave 2–6 per-schema polish                                                                                                                                        |
| M10-DIA-08      | **Type Etalon W1 cycle-feedback** – `cycleFeedbackGeometry` + AgentWorkflow/DataStory/RlProcess + token migrate    | P2 / schema UX     | ✅ 2026-07-23 – Wave 2 linear followed                                                                                                                                                       |
| M10-DIA-09      | **Type Etalon W2 linear vertical** – `buildVerticalColumnOrigin` + spine brothers + M10 tokens-only                | P2 / schema UX     | ✅ 2026-07-23 – Wave 3 funnel followed                                                                                                                                                       |
| M10-DIA-10      | **Type Etalon W3 funnel/stack** – `funnelStackGeometry` + AEC/prompt stack + rule_of_thirds titleWeight            | P2 / schema UX     | ✅ 2026-07-23 – type-etalon waves closed                                                                                                                                                     |
| M10-DIA-11      | **LMS W4 residual caption tokens** – SVG title `800` → `titleWeight` on non-spine diagrams                         | P2 / schema UX     | ✅ 2026-07-23 – LMS diagram polish track complete                                                                                                                                            |
...
| 3     | **Schemų vizualinė patikra** (SCHEME_AGENT §5) – RAG, žinių patikrinimas; tik patikra. ~~custom_gpt_process + M5 di_prezentacijos~~ ✅ 2026-07-24 LMS 1A                                | CODE_REVIEW / SCHEME_AGENT |
