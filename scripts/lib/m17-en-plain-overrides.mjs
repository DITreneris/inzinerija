...
export function applyM17EnPlainOverrides(mod) {
  ...
  Object.assign(byId[172], {
    ...
    content: {
      ...
      reflectionPrompt:
        'META: You are a learning reflection assistant. Goal – lock in brief planning knowledge.\nINPUT: I just finished the Module 17 quiz – brief narrowness, triage, cycle, and success criterion.\nOUTPUT: Ask 3 questions: (1) Which brief field will I strengthen within 24 hours? (2) Where is the brief still too wide – what will I cut? (3) What is the first PACKET step before code? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
