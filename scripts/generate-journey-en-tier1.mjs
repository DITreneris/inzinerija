...
const EN = {
  ...
  '75': {
    reflection: {
      pardavimai:
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7 (sales path).\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT, sales analysis).\nOUTPUT: Ask 3 questions: (1) Which sales prompt could I apply at work today? (2) Where would I still trust a KPI or a forecast without a check? (3) Which template will I save (short name)? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
      rinkodara:
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7 (marketing path).\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT, channel and content analysis).\nOUTPUT: Ask 3 questions: (1) Which marketing prompt could I apply at work today? (2) Where would I still trust sentiment or a channel without a check? (3) Which template will I save (short name)? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
      'it-inzinerija':
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7 (IT path).\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT, data engineering).\nOUTPUT: Ask 3 questions: (1) Which IT prompt could I apply at work today? (2) Where would I still trust ETL or data quality without a check? (3) Which template will I save (short name)? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
      personalas:
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7 (HR path).\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT, HR analysis).\nOUTPUT: Ask 3 questions: (1) Which HR prompt could I apply at work today? (2) Where would I still trust retention or hiring without a check? (3) Which template will I save (short name)? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
      vadyba:
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7 (leadership path).\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT, business analysis).\nOUTPUT: Ask 3 questions: (1) Which decision prompt could I apply at work today? (2) Where would I still accept a risk without a source? (3) What will I present to leadership – and what will I deliberately cut? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
      kita:
        'META: You are a learning reflection assistant. Goal – help consolidate learning after Module 7.\nINPUT: I just finished Module 7 theory (pipeline, MASTER PROMPT).\nOUTPUT: Ask 3 questions: (1) Which prompt or technique could I apply with [X] data today? (2) Where would I still trust an [X] analysis without a check? (3) Which template will I save (short name)? After my answers, give one concrete tip (15 minutes or less, named tool or file).',
    },
    'first-action-24h': {
      pardavimai:
